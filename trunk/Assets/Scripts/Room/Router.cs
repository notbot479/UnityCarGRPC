...
public class Router : MonoBehaviour
{
    ...
    public readonly double mediumRSSIstart = -2f;   //less - green
    public readonly double mediumRSSIend = -90f;     //less - yellow
    public readonly double badRSSIstart = -100f;     //less - red
